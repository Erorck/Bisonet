...
router.get('/Course-More-Groups', async (req, res, next) => {
  try {
...
router.get('/Semester-More-Courses', async (req, res, next) => {
  try {
    //const { size } = req.query;
    //const filter = req.body;
...
router.get('/Group-More-Stundents', async (req, res, next) => {
  try {
    //const { size } = req.query;
    //const filter = req.body;
...
router.get('/Teachers-More-Courses', async (req, res, next) => {
  try {
    //const { size } = req.query;
    //const filter = req.body;
